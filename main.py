...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button2.place(relx=0.617, rely=0.288, height=64, width=118)
        ...
        self.Button3.place(relx=0.727, rely=0.288, height=64, width=118)
        ...
        self.Text1.place(relx=0.617, rely=0.388, relheight=0.33, relwidth=0.346)
        ...
        self.Button4.place(relx=0.617, rely=0.738, height=64, width=118)
        self.Button4.configure(activebackground="beige")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#d9d9d9")
        self.Button4.configure(compound="left")
        self.Button4.configure(disabledforeground="#a3a3a3")
        self.Button4.configure(font="-family {微軟正黑體} -size 15 -weight bold")
        self.Button4.configure(foreground="#000000")
        self.Button4.configure(highlightbackground="#d9d9d9")
        self.Button4.configure(highlightcolor="black")
        self.Button4.configure(pady="0")
        self.Button4.configure(text="""開啟檔案""")
        ...
        self.Button4.configure(command=self.button4_event)
        ...
        if cam is not None:
            ...
            if ret:
                ...
                for barcode in decode(frame):
                    # result decode into chinese
                    result = barcode.data.decode("UTF8")
                    result = result[1:]
    ...
    def button4_event(self):
        # get tk.Text string
        text = self.Text1.get(1.0, tk.END).replace("\n", "")

        # open file by os.system
        os.system(f'"{text}"')
